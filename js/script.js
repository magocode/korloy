$(document).ready(function() {
	...
	//lnb접고펴기
	$(".open_lnb").click(function(){
		if( $(this).hasClass("on") ){
			$("#lnb").removeClass("slim");
			$(this).removeClass("on");
		} else{
			$("#lnb").addClass("slim");
			$(this).addClass("on");
    ...
    //lnb
    $("#lnb .lnb_list > ul > li.lnb_sub a").click(function(){
		if( $(this).next().is(".sub_list") ){
			if( $(this).hasClass("on") ){
				$(this).removeClass("on").next(".sub_list").slideUp("fast");
			} else{
				$("#lnb .lnb_list > ul > li.lnb_sub > a").removeClass("on");
				$("#lnb .lnb_list > ul > li.lnb_sub > .sub_list").slideUp("fast");
				$(this).addClass("on").next(".sub_list").slideDown("fast");
			}
			return false;
		}
	});
